  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link to="/" className="mt-6 inline-flex rounded-full bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground shadow-elegant hover:opacity-90">
          Go home
        </Link>
      </div>
    </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium digital marketing, web development, and branding agency. We move the needle for ambitious brands." },
      { name: "author", content: "Poppinion Solutions" },
      { property: "og:title", content: "Poppinion Solutions" },
      { property: "og:description", content: "Building Public Opinion Digitally" },
